...
Seed the database with the physical menu data:
python app/seed.py
Run the server:
...
Select your imported GitHub repository digiQR-menu/QR-menu.
In the Configure Project settings, specify the following:
...
Click Deploy. Vercel will compile the frontend and output a public URL!
